(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope, $injector, $rootScope, $mdMedia, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, $document, Auth, triBreadcrumbsService, triSettings, triLayout) {
        var vm = this;
