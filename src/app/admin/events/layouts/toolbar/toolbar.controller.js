(function() {
    ...
    angular
        ...
        .controller('EventsToolbarController', EventsToolbarController);

    /* @ngInject */
    function EventsToolbarController($scope, $state, $element, $mdUtil, $mdSidenav, triBreadcrumbsService, uiCalendarConfig) {
        var vm = this;
